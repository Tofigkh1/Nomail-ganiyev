...
export const Calendar = () => {
  ...
  const [eventDate, setEventDate] = useState(""); // Tarih state'i
  const [eventTime, setEventTime] = useState(""); // Zaman state'i
  const [allDay, setAllDay] = useState(false); // Tüm gün seçeneği
