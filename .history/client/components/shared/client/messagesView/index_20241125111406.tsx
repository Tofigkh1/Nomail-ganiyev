...
export default function MessagesView() {
    ...
    return(
        ...
        <div className=" flex justify-center mt-9">
            <h1 className=" w-20 h-7 bg-emerald-100 rounded-lg flex justify-center">Today</h1>
        </div>
...
<div className="fixed bottom-0 w-full z-10 p-2 shadow-md">
                <input 
                    className="w-screen h-10 border border-gray-300 rounded-lg px-4" 
                    placeholder="Search" 
                />
            </div>
