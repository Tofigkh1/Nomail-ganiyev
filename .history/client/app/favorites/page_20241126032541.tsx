...
export default function Home() {
    ...
    const [hoveredComponent, setHoveredComponent] = useState(null); // State to track hovered component
        ...
        <SidebarContext.Provider value={{ expanded, setExpanded }}>
            <div>
                ...
                <div className="flex">
                    ...
                    <div
                        style={{ marginLeft: "73px", overflowY: hoveredComponent === 'FavoritesMessage' ? 'scroll' : 'hidden' }}
                        className=""
                        onMouseEnter={() => setHoveredComponent('FavoritesMessage')}
                    ...
                    {usebutton ? (
                        <div
                            className="w-full"
                            style={{ overflowY: hoveredComponent === 'MessagesView' ? 'scroll' : 'hidden' }}
                            onMouseEnter={() => setHoveredComponent('MessagesView')}
                            onMouseLeave={() => setHoveredComponent(null)}
                        >
                            <MessagesView />
                        </div>
