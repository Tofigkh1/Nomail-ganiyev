...
export default function Sidebar({ children }: { children: ReactNode }) {
    ...
    return (
        <aside className="h-screen bg-headerColor">
            <nav
                className={`h-full flex flex-col bg-headerColor border-r border-whiteLight3 transition-all duration-200 ease-in-out ml-3 ${expanded ? "w-[126%] h-[130%] -z-30" : "w-[95px]"}`}>
