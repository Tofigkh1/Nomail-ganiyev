...
export default function Sidebar({ children }: { children: ReactNode }) {
    ...
    return (
        <aside className="h-screen bg">
            <nav
                className={`h-full flex flex-col bg-white border-r border-whiteLight3 transition-all duration-300 ease-in-out ml-3 ${expanded ? "w-[140%] h-[130%]" : "w-[95px]"}`}>
