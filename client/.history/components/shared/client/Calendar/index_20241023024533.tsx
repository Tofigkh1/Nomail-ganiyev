...
export const Calendar = () => {
  ...
  const handleDayClick = (day) => {
    setPopupDate(new Date(selectedDate.getFullYear(), selectedDate.getMonth(), day));
  ...
  const renderCalendarDays = () => {
    ...
    const startDay = startOfMonth(selectedDate.getMonth(), selectedDate.getFullYear());
    ...
    <div className="calendar-container">
      ...
      {popupVisible && (
        <div className="calendar-popup">
          ...
          {/* Form elements for event details would go here */}
        </div>
      )}
    </div>
  );
