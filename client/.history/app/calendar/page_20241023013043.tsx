...
import { usePathname } from "next/navigation"; // Düzeltme yapıldı
import InboxActiveSvg from "../components/shared/svg/inboxActiveSvg";
import Link from 'next/link'; // Link ekleyerek push işlevi yapıldı
                    ...
                    <div style={{ width: sidebarWidth }}>
                        <Sidebar>
                            ...
                            <SidebarItem
                                ...
                                text="Calendar"
                                onClick={() => {}} // push yerine Link kullanacağız
                            />
                            <Link href="/calendar">
                                <SidebarItem
                                    icon={pathname === '/calendar' ? <InboxActiveSvg /> : <CalendarSvg />}
